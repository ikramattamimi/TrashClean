@php
    $title = 'Edit Media Informasi';
    $form_action = '/super_admin/update-media-informasi';
    $right_button = 'Edit';
@endphp
...
<div class="row d-flex justify-content-center">
    ...
    <form class="mx-1 mx-md-4" action="{{ $form_action }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center d-flex align-items-center">
            ...
            <input class="form-control" name="id" type="text" value="{{ $media_informasi->id }}"
                placeholder="Judul Tutorial" required hidden />

            <div class="col-10 col-xl-10">
                <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-floating flex-fill mb-0">
                        <input class="form-control" name="judul" type="text" value="{{ $media_informasi->judul }}"
                            placeholder="Judul Tutorial" required />
                        <label>Judul</label>
                    </div>
                </div>
                <div class="d-flex flex-row align-items-center mb-4">
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                    <div class="form-floating flex-fill mb-0">
                        <textarea class="form-control" id="konten-tutorial" name="konten" type="text" placeholder="Konten" required>{{ $media_informasi->konten }}</textarea>
                        <script>
