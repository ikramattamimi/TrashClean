...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-center">
      ...
      <a href="index.html" class="logo rounded"><img src="assets/img/logo_clean.png" alt=""
          class="img-fluid"></a>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <div>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi obcaecati, sequi ducimus recusandae
                  eveniet asperiores totam facilis ratione sunt quod ullam aspernatur. Quae mollitia reiciendis veniam
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate autem et distinctio consequatur sit
                eum fugit quisquam. Quasi, voluptatum autem. Nostrum officiis natus obcaecati doloremque, adipisci aut
                porro fugiat ad!</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Unde at quod optio dolores ipsa maiores,
                commodi officiis id distinctio velit aut voluptates quam minima sed iure consectetur facilis! Vitae,
                sunt!</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0"
              src="https://maps.google.com/maps?q=telkom%20university&t=&z=17&ie=UTF8&iwloc=&output=embed"
